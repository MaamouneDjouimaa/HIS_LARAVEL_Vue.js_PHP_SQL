...
class AdminController extends Controller
{
    ...
    public function save_ajouter_etudiant(Request $request)
    {
        ...
        $user->motDePasse = bcrypt($request->password); // Hashage du mot de passe
        $user->save();
    ...
    public function save_update_admin_etudiant(Request $request)
    {
        ...
        $user->email = $request->email;
        $user->motDePasse = bcrypt($request->motDePasse); // Hashage du mot de passe
        $user->update();
    ...
    public function delete_admin_etudiant($id)
    {
        ...
        return redirect()->route('adminEtudiant')->with('status','L\'étudiant a bien été supprimé.');
    }
