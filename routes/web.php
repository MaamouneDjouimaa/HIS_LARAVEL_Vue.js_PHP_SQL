...
Route::get('/etudiantPortail', function () {
    return view('/etudiantPortail/etudiantPortail');
});
...
use App\Http\Controllers\Voirauth;
use App\Http\Controllers\authCandidatController;
use App\Http\Controllers\CandidatureEspaceController;
...
Route::get('/bureauPortail/ListeCandidature/Accepter/{id}', [BureauInscriptionController::class, 'accepter'])->name('CandidatAccepter');
Route::get('/bureauPortail/ListeCandidature/Refuser/{id}', [BureauInscriptionController::class, 'refuser'])->name('CandidatRefuser');
Route::get('/bureauPortail/ListeCandidature/Reorienter/{id}', [BureauInscriptionController::class, 'reorienter'])->name('CandidatReorienter');
...
Route::get('/Espace_Candidature',[CandidatureEspaceController::class, 'index'])->name('EspaceCandidature');
Route::get('/Espace_Candidature/{id}',[CandidatureEspaceController::class,'espace_candidature'])->name('saveEspaceCandidature');
...
Route::get('/candidat/connexion', [AuthCandidatController::class, 'showLoginForm'])->name('candidat.login');
Route::post('/candidat/connexion', [AuthCandidatController::class, 'login'])->name('candidat.login.submit');

Route::get('/candidat/inscription', [AuthCandidatController::class, 'showRegistrationForm'])->name('candidat.register');
Route::post('/candidat/inscription', [AuthCandidatController::class, 'register'])->name('candidat.register.submit');

use Laravel\Socialite\Facades\Socialite;

Route::get('login/google', [AuthCandidatController::class, 'redirectToGoogle'])->name('candidat.login.google');
Route::get('login/google/callback', [AuthCandidatController::class, 'handleGoogleCallback'])->name('candidat.login.google.callback');
