...
const customNavbarIcon = document.querySelector(".custom-navbar-icon");

customSidebarClose.addEventListener("click", () => {
    customSidebar.classList.toggle("close");
    customNavbarIcon.classList.toggle("fa-chevron-left");
    customNavbarIcon.classList.toggle("fa-chevron-right");
});
