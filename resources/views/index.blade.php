        ...
        <div class="carousel-item active">
          ...
          <div class="container">
            <div class="carousel-caption">
              <h1>CONNECTEZ LE SAVOIR À L'ÉXCELLENCE</h1>
              <p>
              Higher Institute of Sciences (HIS) est la première université privée algérienne multidisciplinaire <br> fondée en 2019, et accréditée par le ministère de l’Enseignement Supérieur et <br>de la Recherche Scientifique, à partir du 26 novembre 2019 sous le n°1951.
              </p>
              <p>
                <a class="btn btn-lg btn-primary" href="#">S'inscrire maintenant'</a>
              </p>
            </div>
          </div>
        </div>
