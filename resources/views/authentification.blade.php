    ...
    <div class="form-content">
        ...
        <form action="{{ route('login') }}" method="POST" novalidate>
            ...
            <div class="field input-field">
                <input type="email" placeholder="Email universitaire (example@his.edu.dz)" name="email" id="connexion-email" onkeyup="validateConnexionEmail()" class="input">
            ...
            <div class="field input-field">
                ...
                <span id="connexion-password-erreur" class="error-message">{{ $errors->first('password') }}</span>
            </div>
