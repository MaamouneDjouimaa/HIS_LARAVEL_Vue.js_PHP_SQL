                ...
                <section class="container">
                    ...
                    <form action="#" class="form">
                      ...
                      <div class="text-center mt-5 btn-decision" >
                        <a href="{{  route('CandidatAccepter', ['id' => $candidat->idCand]) }}" class="btn btn-primary m-2" id="accepter">
                        ...
                        <a href="{{ route('CandidatRefuser', ['id' => $candidat->idCand]) }}" class="btn btn-primary m-2" id="refuser">
