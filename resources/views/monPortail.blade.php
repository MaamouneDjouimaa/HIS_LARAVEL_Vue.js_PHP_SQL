...
<body>
  ...
  <div class="container mt-4">
    ...
    <div class="row">
      <div class="col-md-12">
        <p>monPortail offre un accès centralisé à différents services <br>la demande de stage externe, la consultation <br> des relevés de notes, délibérations et la demande <br> des documents administratifs, et boucoup plus encore !</p>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="image-container">
                <img src="{{ asset('images/stock_laptob_phone.png') }}" alt="Description de l'image">
            </div>
          </div>
        </div>
